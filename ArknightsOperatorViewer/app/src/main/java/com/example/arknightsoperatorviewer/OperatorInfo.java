...
public class OperatorInfo implements Serializable {
    ...
    public static class Operator45Star extends OperatorInfo
    {
        ...
        public static class Operator6Star extends Operator45Star
        {
            public Operator6Star(String name, String type, String profile, String clinicalAnalysis, String trust1, String trust2, String trust3, String trust4, int stars, String affiliation, String promo) {
                super(name, type, profile, clinicalAnalysis, trust1, trust2, trust3, trust4, stars, affiliation, promo);
            }
        }
